...
list_of_interesting_codes = dict()
# Program variables
...
while True:
    ...
    if good_checksum:
        ...
        # Split the telegram back into lines and iterate over them
        ...
        for code in telegram_values:
            #print code, 'has', telegram_values[code]
            if code in list_of_interesting_codes:
                # Cleanup value
                # Print nicely formatted string with clean value
                # Push to Xively
                pass
        pp = pprint.PrettyPrinter(indent=4)
        pp.pprint(telegram_values)
